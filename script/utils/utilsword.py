...
class UtilsWord():
    def __init__(self, ):
        ...
        error_word_list = [  
            [ " l ", " I " ], [ "l've", "I've" ], [ "I m ", "I'm " ]  ,[ "Im ", "I'm " ]  , [ "Tm", "I'm" ], [ "lim ", "I'm" ]   ,[ "l want", "I want" ]  ,
            [ " l can", " I can" ],[" lts ", " It's "],
            [ "lt's", "It's"] ,[ "isnt", "isn't" ] ,[ "Itis ", "It is " ],[ " ls ", " is " ],[ " ln ", " In " ],
            [ "Guessl", "Guess!" ] ,[ "friendl", "friend!" ] ,[ "Greatel", "Greate!" ] , ["ideal", "idea!" ] ,[ "Lookl","look!" ] ,[ "lookl", "look!" ] ,
            [ "of ten", "often" ] ,[ "loften", "I often" ],[ "offcn", "often" ]  ,
            [ "Wow", "wow" ] ,[ "furure", "future" ]  ,[ "Dont", "Don't" ] , [ "moming", "morning" ] ,[ "miming"," morning" ] ,
            [ "Idlike", "I'd like" ] ,[ "They re ","They're " ] ,[ "gomg ","going " ],[ "tomorow","tomorrow" ],[ "treel","tree!" ],[ "lt","It" ],
